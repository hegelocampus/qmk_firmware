...
[_LOWER] = LAYOUT( \
  ...
  _______, KC_F11,  KC_F12,  KC_LCBR, KC_RCBR, _______,                   KC_COLON, KC_UNDS, KC_PLUS, KC_PIPE, _______, _______,\
...
[_RAISE] = LAYOUT( \
  ...
  KC_GRV,  _______, _______, KC_LBRC, KC_RBRC, _______,                     KC_SCLN, KC_MINS,  KC_EQL , KC_BSLS, _______, _______, \
